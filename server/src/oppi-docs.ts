...
export const MOBILE_OUTPUT_GUIDE = [
  ...
  "- Wiki links open real workspace or owner-host files: [[path/to/file.ext|Label]], [[path/to/file.ext#L12-L18|Label]], [[/abs/path|Label]], [[~/path|Label]]. Recognized documents and media (images, audio, video, PDF, HTML, Org, LaTeX, Mermaid, Graphviz) open in viewers. oppi://session/<session-id> opens a session.",
