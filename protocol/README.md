...
| `/control-sessions/:sessionId/stream`                 | Bidirectional WebSocket JSON          | `BoundSessionStreamMux` | `WebSocketClient` via `SessionStreamCoordinator`       | Focused control-session timeline and commands, scope-bound by explicit control metadata.                              |
