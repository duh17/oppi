...
- **Area:** `pi-remote/src/policy.ts` (`parseBashCommand`, `matchesRule`)
...
- Added regression coverage in:
  - `pi-remote/tests/policy-fuzz.test.ts`
  - `pi-remote/tests/policy-host.test.ts`
  - `pi-remote/tests/policy.test.ts`
