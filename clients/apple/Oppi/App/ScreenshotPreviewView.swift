...
struct ScreenshotPreviewView: View {
    var body: some View {
        ...
        case "whats-new-build48-light":
            WhatsNewScreenshotPreview(themeID: .light)
        case "whats-new-build48-dark":
...
private struct SyntaxLanguagesPreview: View {
    enum Page {
        case webAndDynamic
...
private struct QuietWorkStripPreview: View {
...
private struct ChatFileBrowserPanelPreview: View {
