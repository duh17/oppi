...
struct APIClientTests {
    ...
    @Test func createWorkspaceSessionEncodesWorktreeId() async throws {
        ...
        MockURLProtocol.handler = { request in
            ...
            return self.mockResponse(json: """
            {"session":{"id":"new","workspaceId":"w1","worktreeId":"wt_feature","status":"ready","createdAt":0,"lastActivity":0,"messageCount":0,"tokens":{"input":0,"output":0},"cost":0}}
            """)
        }
    ...
    @Test func getSessionEventsDecodesSequencedCatchUp() async throws {
        ...
        guard case .messageEnd(_, let content, _, _) = response.events[1].message else {
