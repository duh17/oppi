...
private let logger = Logger(subsystem: "dev.chenda.PiRemote", category: "Biometric")
...
final class BiometricService {
    ...
    private static let thresholdKey = "dev.chenda.PiRemote.biometric.threshold"
    private static let enabledKey = "dev.chenda.PiRemote.biometric.enabled"
