...
private let logger = Logger(subsystem: "dev.chenda.PiRemote", category: "SkillEditor")
...
extension Notification.Name {
    static let editorFormatAction = Notification.Name("dev.chenda.PiRemote.editorFormatAction")
}
