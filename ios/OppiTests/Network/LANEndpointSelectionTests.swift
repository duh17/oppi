...
struct LANEndpointSelectionTests {
    ...
    @Test func fallsBackToPairedWhenNoDiscoveryCandidate() {
        ...
        #expect(result?.baseURL.absoluteString == "https://mac-studio.taila3ebc.ts.net:7749")
        #expect(result?.streamURL.absoluteString == "wss://mac-studio.taila3ebc.ts.net:7749/stream")
    }
