...
> **Superseded by [`docs/design/multi-agent.md`](../../docs/design/multi-agent.md).** Research notes and early ideation. The consolidated design doc reflects what shipped and current thinking.
