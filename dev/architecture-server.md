...
| Provider usage quotas                       | [provider-quotas.md](../docs/provider-quotas.md); `server/src/provider-quota/` (`adapters/registry.ts` to add a provider; shared DTO + Apple compact/detail presentation)                       |
